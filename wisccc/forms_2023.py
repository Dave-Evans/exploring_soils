...
class SurveyFieldFormFull_2023_partb(forms.ModelForm):
    ...
    cover_crop_planting_cost = forms.IntegerField(
        label=mark_safe(
            '45. Estimated cover crop planting cost per acre in this field. Please use <a href="https://www.nass.usda.gov/Statistics_by_State/Wisconsin/Publications/WI-CRate20.pdf" target="_blank" rel="noopener noreferrer">UW Extension Custom Rate Guide.</a>'
        ),
        min_value=0,
        required=True,
    )
