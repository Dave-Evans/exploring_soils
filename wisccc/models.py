...
class CoverCropChoices(models.TextChoices):
    ...
    BLANK = "", ""
    ANNUAL_RYEGRASS = "ANNUAL_RYEGRASS", "annual ryegrass"
    BARLEY = "BARLEY", "barley"
    BERSEEM_CLOVER = "BERSEEM_CLOVER", "berseem clover"
    CANOLA = "CANOLA", "canola/rapeseed"
    CEREAL_RYE = "CEREAL_RYE", "cereal (winter) rye"
    CRIMSON_CLOVER = "CRIMSON_CLOVER", "crimson clover"
    COWPEA = "COWPEA", "cowpea"
    FIELD_PEA = "FIELD_PEA", "field/forage pea"
    HAIRY_VETCH = "HAIRY_VETCH", "hairy vetch"
    KALE = "KALE", "kale"
    OATS = "OATS", "oats"
    ...
    RED_CLOVER = "RED_CLOVER", "red clover"
