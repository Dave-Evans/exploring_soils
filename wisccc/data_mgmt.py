...
def get_survey_data():
    ...
    dct_choices = {
        ...
        "manure_prior_source": ManureSourceChoices,
    ...
    df = pd.DataFrame(
        list(
            survey_fields.values_list(
                ...
                "survey_farm__main_cc_goal_this_year_write_in",
                "survey_farm__satisfied_with_cc_results",
                "survey_farm__satisfied_with_cc_results_write_in",
                "survey_farm__biggest_challenge_cc",
                "survey_farm__biggest_challenge_cc_changed_over_time",
                "survey_farm__learning_history_cc",
                "survey_farm__conservation_programs",
                "survey_farm__conservation_programs_which_ones",
                "survey_farm__conservation_programs_if_helped_how",
                ...
                "survey_farm__learn_about_cc_preferred_way",
                "survey_farm__scenario_tool_feedback",
                "survey_farm__testimonial",
                "survey_farm__willing_to_share_more",
                # From SurveyField
                "id",
                "crop_rotation",
