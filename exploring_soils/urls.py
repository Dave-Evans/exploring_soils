...
urlpatterns = [
    ...
    url(r'^explore_soils/$', plotter_views.soils_in_depth, name='explore_soils'),
    url(r'^soils_in_depth/$', plotter_views.soils_in_depth, name='soils_in_depth'),
    url(r'^pull_soils/(?P<minx>-?\d+\.\d+)/(?P<miny>-?\d+\.\d+)/(?P<maxx>-?\d+\.\d+)/(?P<maxy>-?\d+\.\d+)/$', plotter_views.pull_soils, name='pull_soils'),
    ...
    url(r'^kanopy_map$', kanopy_views.kanopy_submission_map, name='kanopy_submission_map'),
    url(r'^kanopy_submissions_json$', kanopy_views.kanopy_submissions_json, name='kanopy_submissions_json'),
    ...
    url(r'^kanopy/datalook/2020_21$', kanopy_views.datalook_2020_21, name='datalook_2020_21'),    
