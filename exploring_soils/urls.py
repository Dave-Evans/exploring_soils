...
urlpatterns = [
    ...
    path('kanopy/groundcover_update/<int:pk>/', kanopy_views.GroundcoverUpdateView.as_view(), name='groundcover_update'),
    ...
    url(r'^kanopy/submissions$', kanopy_views.kanopy_submissions, name='kanopy_submissions'),
    ...
    url(r'^kanopy/barchart$', kanopy_views.kanopy_sub_graph, name='kanopy_sub_graph'),
