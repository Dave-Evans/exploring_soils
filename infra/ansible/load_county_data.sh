...
# ogr2ogr -overwrite -f PostgreSQL PG:"host=localhost dbname=db_davemike user=usr_davemike password=pass" -t_srs EPSG:4326 -nln mn_counties ./data/county_nrcs_a_mn.gdb county_nrcs_a_mn
# ogr2ogr -overwrite -f PostgreSQL PG:"host=localhost dbname=db_davemike user=usr_davemike password=pass" -t_srs EPSG:4326 -nln wi_counties ./data/county_nrcs_a_wi.gdb county_nrcs_a_wi
