...
dat_survey <- read_excel(
  "~/Documents/small_projects/wisc_cc/data_from_mrill/CitSci CCROP 2022 responses agronomic.xlsx",
  sheet = 1
)
...
dat_all <- dat_all %>%
  mutate(
    precip_preplant_3_wk = NA,
    precip_preplant_2_wk = NA,
    precip_preplant_1_wk = NA,
    precip_postplant_1_wk = NA,
    precip_postplant_2_wk = NA,
    precip_postplant_3_wk = NA
  )
